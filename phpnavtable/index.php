...
<html lang="en">
  ...
  <nav class="main_menu navbar navbar-expand-lg bg-white container my-4">
    ...
    <div class="container">
    <h3 class="text-white d-flex justify-content-center text-decoration-underline mb-5">Tableau des pages d'admin</h3>

        <form action="ajouternav.php" method="post" class="mt-4">
            <div class="form-group">
                <label for="" class="form-label fw-bold text-success">Titre de Table :</label>
                <input type="text" class="form-control" name="nv" placeholder="par exemple : navbar">
            </div>
            <div class="form-group">
                <label for="" class="form-label fw-bold text-success">Nom de dossier au VSC :</label>
                <input type="text" class="form-control" name="rfr" placeholder="par exemple : phpnav">
            </div>
